...
RSpec.describe ApplicationHelper, type: :helper do
  ...
  describe 'Navigation bar' do
    it 'Dashboard: Just tittle' do
      allow(controller).to receive_messages(controller_name: 'dashboard', action_name: 'index')
    ...
    it '1 level depth' do
      allow(controller).to receive_messages(controller_name: 'units', action_name: 'index')

...
RSpec.describe TasksController, type: :controller do
  ...
  describe 'POST #create' do
    ...
    context 'with invalid params' do
      it 'assigns a newly created but unsaved task as @task' do
        post :create, params: { user_id: @user, project_id: @project, task: invalid_attributes }
        expect(assigns(:task)).to be_a_new(Task)
      end
  ...
  describe 'PUT #update' do
    context 'with valid params' do
      ...
      it 'updates the requested task' do
        task = Task.create! valid_attributes
        put :update, params: { user_id: @user, project_id: @project, id: task.to_param, task: new_attributes }
        task.reload
      ...
      it 'assigns the requested task as @task' do
        task = Task.create! valid_attributes
        put :update, params: { user_id: @user, project_id: @project, id: task.to_param, task: valid_attributes }
        expect(assigns(:task)).to eq(task)
      end
    ...
    context 'with invalid params' do
      it 'assigns the task as @task' do
        task = Task.create! valid_attributes
        put :update, params: { user_id: @user, project_id: @project, id: task.to_param, task: invalid_attributes }
        expect(assigns(:task)).to eq(task)
      end
  ...
  describe 'DELETE #destroy' do
    it 'destroys the requested task' do
      task = Task.create! valid_attributes
      expect {
        delete :destroy, params: { user_id: @user, project_id: @project, id: task.to_param }
      }.to change(Task, :count).by(-1)
    end

...
RSpec.describe TimeLogsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested time_log as @time_log" do
      time_log = TimeLog.create! valid_attributes
      get :show, {:id => time_log.to_param}, valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested time_log as @time_log" do
      time_log = TimeLog.create! valid_attributes
      get :edit, {:id => time_log.to_param}, valid_session
      expect(assigns(:time_log)).to eq(time_log)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new TimeLog" do
        expect {
          post :create, {:time_log => valid_attributes}, valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved time_log as @time_log" do
        post :create, {:time_log => invalid_attributes}, valid_session
        expect(assigns(:time_log)).to be_a_new(TimeLog)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested time_log" do
        time_log = TimeLog.create! valid_attributes
        put :update, {:id => time_log.to_param, :time_log => new_attributes}, valid_session
        time_log.reload
      ...
      it "assigns the requested time_log as @time_log" do
        time_log = TimeLog.create! valid_attributes
        put :update, {:id => time_log.to_param, :time_log => valid_attributes}, valid_session
        expect(assigns(:time_log)).to eq(time_log)
      end
    ...
    context "with invalid params" do
      it "assigns the time_log as @time_log" do
        time_log = TimeLog.create! valid_attributes
        put :update, {:id => time_log.to_param, :time_log => invalid_attributes}, valid_session
        expect(assigns(:time_log)).to eq(time_log)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested time_log" do
      time_log = TimeLog.create! valid_attributes
      expect {
        delete :destroy, {:id => time_log.to_param}, valid_session
      }.to change(TimeLog, :count).by(-1)
    end

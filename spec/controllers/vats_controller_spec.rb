...
RSpec.describe VatsController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "redirects to the created vat" do
        post :create, {:vat => valid_attributes}, valid_session
        expect(response).to redirect_to(Vat.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved vat as @vat" do
        post :create, {:vat => invalid_attributes}, valid_session
        expect(assigns(:vat)).to be_a_new(Vat)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested vat" do
        vat = Vat.create! valid_attributes
        put :update, {:id => vat.to_param, :vat => new_attributes}, valid_session
        vat.reload
      ...
      it "redirects to the vat" do
        vat = Vat.create! valid_attributes
        put :update, {:id => vat.to_param, :vat => valid_attributes}, valid_session
        expect(response).to redirect_to(vat)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the vat as @vat" do
        vat = Vat.create! valid_attributes
        put :update, {:id => vat.to_param, :vat => invalid_attributes}, valid_session
        expect(assigns(:vat)).to eq(vat)
      end
  ...
  describe "DELETE #destroy" do
    ...
    it "redirects to the vats list" do
      vat = Vat.create! valid_attributes
      delete :destroy, {:id => vat.to_param}, valid_session
      expect(response).to redirect_to(vats_url)
    end
  end
